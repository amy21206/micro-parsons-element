...
class ParsonsInput {
    constructor() {
        ...
        this.setSourceBlocks = (data, tooltips) => {
            // reset
        ...
        this.setExpandableBlocks = (expandableBlocks) => {
            this.expandableBlocks = expandableBlocks;
        };
        this._getBlockPosition = (block) => {
            let position = 0;
...
class TestStringInput {
    constructor(slotName) {
        ...
        this.updateMatchResult = (matches) => {
            this.quill?.removeFormat(0, this.quill.getLength() - 1, 'silent');
            let startPos = 0;
            let matchPos;
        ...
        this.updateGroupedMatchResult = (matches, colors) => {
            this.quill?.removeFormat(0, this.quill.getLength() - 1, 'silent');
            if (matches.length == 0) {
                return;
            }
        ...
        this.updateGroupedMatchResult_exp = (matches) => {
            let i = 0;
            for (let j = 0; j < matches.length; ++j) {
...
class UnitTestTable {
    constructor() {
        ...
        */
        this.match = (index, regex, testCase) => {
            const result = { success: false, match: null, errorMessage: null };
            ...
            try {
                ...
                result.success = true;
                result.match = window.pyodide.globals.unit_match_result;
                // console.log(result)
        ...
        this._getRevealedRow = (testCase, result) => {
...
var logger_async = createCommonjsModule(function (module, exports) {
...
var LoggerAsync = /** @class */ (function () {
    ...
    LoggerAsync.prototype.log = function (msg, meta) {
        if (meta === void 0) { meta = { level: enums.Level.BASE }; }
    ...
    LoggerAsync.prototype.error = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.log(msg, { level: enums.Level.ERROR })];
    ...
    LoggerAsync.prototype.warn = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.log(msg, { level: enums.Level.WARN })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    LoggerAsync.prototype.info = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.log(msg, { level: enums.Level.INFO })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    LoggerAsync.prototype.debug = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.log(msg, { level: enums.Level.DEBUG })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
var s3_bucket_handler = createCommonjsModule(function (module, exports) {
var __awaiter = (commonjsGlobal && commonjsGlobal.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
var S3BucketHandler = /** @class */ (function () {
    function S3BucketHandler(_a) {
        var api = _a.api, bucket = _a.bucket, path = _a.path, formatter = _a.formatter, _b = _a.level, level = _b === void 0 ? enums.Level.BASE : _b;
        this._api = api;
        this._bucket = bucket;
        this._path = path;
        this._level = level;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2: throw new (_a.apply(errors.HTTPError, [void 0, _c.apply(_b, [(_e[_d] = _f.sent(),
...
var regex_tool_s3_bucket_logger = createCommonjsModule(function (module, exports) {
var __extends = (commonjsGlobal && commonjsGlobal.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var RegexToolS3BucketLogger = /** @class */ (function (_super) {
    ...
    function RegexToolS3BucketLogger(_a) {
        var api = _a.api, bucket = _a.bucket, path = _a.path, _b = _a.level, level = _b === void 0 ? enums.Level.BASE : _b, _c = _a.handlers, handlers = _c === void 0 ? [] : _c, errorHandler = _a.errorHandler;
        var _this = this;
        var formatter = new json_formatter.JSONDataFormatter();
        var handler = new s3_bucket_handler.S3BucketHandler({
            api: api,
            bucket: bucket,
            path: path,
            formatter: formatter,
...
class RegexElement extends HTMLElement {
    constructor() {
        ...
        */
        ...
        this.addToOutput = (originalOutput) => {
            let output = '';
        ...
        this.logProblemFinished = (completed) => {
